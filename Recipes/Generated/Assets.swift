...
internal enum Asset {
  ...
  internal enum Colors {
    ...
    internal static let greenMist = ColorAsset(name: "green-mist")
    internal static let textColorSecondary = ColorAsset(name: "text-color-secondary")
    internal static let textColor = ColorAsset(name: "text-color")
    internal static let tusk = ColorAsset(name: "tusk")
    internal static let zuccini = ColorAsset(name: "zuccini")
  }
}
